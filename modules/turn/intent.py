...
FAREWELL_WORDS = {
    "bye", "goodbye", "see you", "good night", "goodnight", "take care",
    "peace out", "talk later", "that's all", "that is all",
}

BACKCHANNEL_WORDS = {
    "okay", "ok", "uh-huh", "uh huh", "mhmm", "mm-hmm", "got it",
    "right", "yeah", "yep", "sure", "alright", "aha", "cool", "thanks",
...
IMPERATIVE_VERBS = {
    "play", "stop", "start", "pause", "resume", "tell", "show", "remind",
    "set", "open", "close", "search", "find", "create", "add", "delete",
    "remove", "turn", "send", "call", "cancel", "skip", "repeat", "explain",
}
